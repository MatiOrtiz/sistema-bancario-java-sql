...
VALUES (1, '2023-6-6', 6, 200000, 17, 0, 0, 1, 1);  # esta pago
INSERT INTO prestamo(nro_prestamo, fecha, cant_meses, monto, tasa_interes, interes, valor_cuota,legajo, nro_cliente) 
VALUES (2, '2024-4-4', 6, 900000, 20, 0, 0, 1, 1);  # moroso

# prestamos del cliente 2 (y empleado 2)
INSERT INTO prestamo(nro_prestamo, fecha, cant_meses, monto, tasa_interes, interes, valor_cuota,legajo, nro_cliente)
VALUES (3, '2023-4-4', 6, 500000, 20, 0, 0, 2, 2);   # esta pago
INSERT INTO prestamo(nro_prestamo, fecha, cant_meses, monto, tasa_interes, interes, valor_cuota,legajo, nro_cliente)
VALUES (4, '2024-4-5', 6, 2000000, 24, 0, 0, 2, 2); # moroso

# prestamos del cliente 3 (y empleado 3)
INSERT INTO prestamo(nro_prestamo, fecha, cant_meses, monto, tasa_interes,interes, valor_cuota, legajo, nro_cliente)
VALUES (5, '2024-1-7', 6, 1800000, 24, 0, 0, 3, 3); # moroso

# prestamos del cliente 4 (y empleado 4)
INSERT INTO prestamo(nro_prestamo, fecha, cant_meses, monto, tasa_interes, interes, valor_cuota, legajo, nro_cliente)
VALUES (6, '2022-9-9', 6, 2000000, 24, 0, 0, 4, 4); # esta pagado
INSERT INTO prestamo(nro_prestamo, fecha, cant_meses, monto, tasa_interes, interes, valor_cuota, legajo, nro_cliente)
VALUES (7, '2024-9-20', 6, 100000, 17, 0, 0, 4, 4); # cuotas impagas, pero al dia
...
UPDATE pago SET fecha_venc = '2023-07-06', fecha_pago = '2023-07-04' WHERE nro_prestamo = 1 and nro_pago = 1;
UPDATE pago SET fecha_venc = '2023-08-06', fecha_pago = '2023-08-04' WHERE nro_prestamo = 1 and nro_pago = 2;
UPDATE pago SET fecha_venc = '2023-09-06', fecha_pago = '2023-09-04' WHERE nro_prestamo = 1 and nro_pago = 3;
UPDATE pago SET fecha_venc = '2023-10-06', fecha_pago = '2023-10-04' WHERE nro_prestamo = 1 and nro_pago = 4;
UPDATE pago SET fecha_venc = '2023-11-06', fecha_pago = '2023-11-04' WHERE nro_prestamo = 1 and nro_pago = 5;
UPDATE pago SET fecha_venc = '2023-12-06', fecha_pago = '2023-12-04' WHERE nro_prestamo = 1 and nro_pago = 6; 

# del prestamo 2 (moroso: tiene la cuota 4, 5 y 6 cuotas vencidas e impagas)
UPDATE pago SET fecha_venc = '2023-05-04', fecha_pago = '2023-05-04' WHERE nro_prestamo = 2 and nro_pago = 1;
UPDATE pago SET fecha_venc = '2023-06-04', fecha_pago = '2023-06-04' WHERE nro_prestamo = 2 and nro_pago = 2;
UPDATE pago SET fecha_venc = '2023-07-04', fecha_pago = '2023-07-04' WHERE nro_prestamo = 2 and nro_pago = 3;
UPDATE pago SET fecha_venc = '2023-08-04', fecha_pago = NULL WHERE nro_prestamo = 2 and nro_pago = 4;
UPDATE pago SET fecha_venc = '2023-09-04', fecha_pago = NULL WHERE nro_prestamo = 2 and nro_pago = 5;
UPDATE pago SET fecha_venc = '2023-10-04', fecha_pago = NULL WHERE nro_prestamo = 2 and nro_pago = 6;

# del prestamo 3 (esta pago)
UPDATE pago SET fecha_venc = '2023-05-04', fecha_pago = '2023-05-04' WHERE nro_prestamo = 3 and nro_pago = 1;
UPDATE pago SET fecha_venc = '2023-06-04', fecha_pago = '2023-06-04' WHERE nro_prestamo = 3 and nro_pago = 2;
UPDATE pago SET fecha_venc = '2023-07-04', fecha_pago = '2023-07-04' WHERE nro_prestamo = 3 and nro_pago = 3;
UPDATE pago SET fecha_venc = '2023-08-04', fecha_pago = '2023-08-06' WHERE nro_prestamo = 3 and nro_pago = 4;
UPDATE pago SET fecha_venc = '2023-09-04', fecha_pago = '2023-09-06' WHERE nro_prestamo = 3 and nro_pago = 5;
UPDATE pago SET fecha_venc = '2023-10-04', fecha_pago = '2023-10-06' WHERE nro_prestamo = 3 and nro_pago = 6;

# del prestamo 4 (moroso: tiene la cuota 5 y 6 vencidas e impagas)
UPDATE pago SET fecha_venc = '2024-05-05', fecha_pago = '2024-05-05' WHERE nro_prestamo = 4 and nro_pago = 1;
UPDATE pago SET fecha_venc = '2024-06-05', fecha_pago = '2024-06-05' WHERE nro_prestamo = 4 and nro_pago = 2;
UPDATE pago SET fecha_venc = '2024-07-05', fecha_pago = '2024-07-05' WHERE nro_prestamo = 4 and nro_pago = 3;
UPDATE pago SET fecha_venc = '2024-08-05', fecha_pago = '2024-08-05' WHERE nro_prestamo = 4 and nro_pago = 4;
UPDATE pago SET fecha_venc = '2024-09-05', fecha_pago = NULL WHERE nro_prestamo = 4 and nro_pago = 5;
UPDATE pago SET fecha_venc = '2024-10-05', fecha_pago = NULL WHERE nro_prestamo = 4 and nro_pago = 6;

# del prestamo 5 (moroso: tiene las cuotas 2 a 6 vencidas e impagas)
UPDATE pago SET fecha_venc = '2024-02-07', fecha_pago = '2024-02-07' WHERE nro_prestamo = 5 and nro_pago = 1;
UPDATE pago SET fecha_venc = '2024-03-07', fecha_pago = NULL WHERE nro_prestamo = 5 and nro_pago = 2;
UPDATE pago SET fecha_venc = '2024-04-07', fecha_pago = NULL WHERE nro_prestamo = 5 and nro_pago = 3;
UPDATE pago SET fecha_venc = '2024-05-07', fecha_pago = NULL WHERE nro_prestamo = 5 and nro_pago = 4;
UPDATE pago SET fecha_venc = '2024-06-07', fecha_pago = NULL WHERE nro_prestamo = 5 and nro_pago = 5;
UPDATE pago SET fecha_venc = '2024-07-07', fecha_pago = NULL WHERE nro_prestamo = 5 and nro_pago = 6;

# del prestamo 6 (esta pago)
UPDATE pago SET fecha_venc = '2022-10-9', fecha_pago = '2022-10-9' WHERE nro_prestamo = 6 and nro_pago = 1;
UPDATE pago SET fecha_venc = '2022-11-9', fecha_pago = '2022-11-9' WHERE nro_prestamo = 6 and nro_pago = 2;
UPDATE pago SET fecha_venc = '2022-12-9', fecha_pago = '2022-12-9' WHERE nro_prestamo = 6 and nro_pago = 3;
UPDATE pago SET fecha_venc = '2023-1-9', fecha_pago = '2023-1-9' WHERE nro_prestamo = 6 and nro_pago = 4;
UPDATE pago SET fecha_venc = '2023-2-9', fecha_pago = '2023-2-9' WHERE nro_prestamo = 6 and nro_pago = 5;
UPDATE pago SET fecha_venc = '2023-3-9', fecha_pago = '2023-3-9' WHERE nro_prestamo = 6 and nro_pago = 6;

# del prestamo 7 (tiene cuotas impagas, pero esta al dia)
UPDATE pago SET fecha_venc = '2024-10-20', fecha_pago = '2024-10-20' WHERE nro_prestamo = 7 and nro_pago = 1;
UPDATE pago SET fecha_venc = '2024-11-20', fecha_pago = '2024-11-20' WHERE nro_prestamo = 7 and nro_pago = 2;
UPDATE pago SET fecha_venc = '2024-12-20', fecha_pago = NULL WHERE nro_prestamo = 7 and nro_pago = 3;
UPDATE pago SET fecha_venc = '2025-1-20', fecha_pago = NULL WHERE nro_prestamo = 7 and nro_pago = 4;
UPDATE pago SET fecha_venc = '2025-2-20', fecha_pago = NULL WHERE nro_prestamo = 7 and nro_pago = 5;
UPDATE pago SET fecha_venc = '2025-3-20', fecha_pago = NULL WHERE nro_prestamo = 7 and nro_pago = 6;


#...............................................................................
# Tasas prestamos
 
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (6,0,299999,17);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (6,300000,999999,20);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (6,1000000,2000000,24);  

INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (12,0,299999,18.5);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (12,300000,999999,21.5);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (12,1000000,2000000,25.5);  

# periodo nuevo de 18 meses, no estaba en el enunciado del proyecto 1
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (18,0,299999,19);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (18,300000,999999,22);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (18,1000000,2000000,26);  

INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (24,0,299999,20);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (24,300000,999999,23);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (24,1000000,2000000,27);  

INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (60,0,299999,25);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (60,300000,999999,28);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (60,1000000,2000000,32);  

INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (120,0,299999,30);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (120,300000,999999,33);  
INSERT INTO tasa_prestamo(periodo, monto_inf, monto_sup, tasa) VALUES (120,1000000,2000000,37);  
...
INSERT INTO transaccion(nro_trans, fecha, hora, monto) 
VALUES(1004,'2024-10-4','13:30:00',501); 
...
INSERT INTO transaccion(nro_trans, fecha, hora, monto) 
VALUES(1008,'2024-10-8','13:30:00',502); 
...
INSERT INTO transaccion(nro_trans, fecha, hora, monto) 
VALUES(1012,'2024-10-12','13:30:00',503); 
...
INSERT INTO transaccion(nro_trans, fecha, hora, monto) 
VALUES(1016,'2024-10-16','13:30:00',504); 
...
INSERT INTO transaccion(nro_trans, fecha, hora, monto) 
VALUES(2,'2024-9-1','13:30:00',2000);
...
INSERT INTO transaccion(nro_trans, fecha, hora, monto) 
VALUES(3,'2024-9-1','13:30:00',3000); 
...
INSERT INTO transaccion(nro_trans, fecha, hora, monto) 
VALUES(4,'2024-9-1','13:30:00',4000); 
